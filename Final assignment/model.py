...
MODEL_NAME = "segformer-step1-plain-transformer"
MODEL_DESCRIPTION = (
    "Step 1: a plain single-stage transformer for segmentation with non-overlapping "
    "patches, standard self-attention, a plain FFN, and a simple decoder."
)
LAYER_NORM_EPS = 1e-6
